...
const Leave: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 Ccard">
            <form ref={formRef} onSubmit={handleAdd} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" noValidate>
                ...
                <div className="mb-4 grid grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="fullDay" className="block text-gray-700 text-sm font-bold mb-2">
                ...
                <div className="flex items-center ">
                    ...
                    <button type="button" onClick={handleReset} className="Lbutton bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Reset
                    </button>
                </div>
            </form>
